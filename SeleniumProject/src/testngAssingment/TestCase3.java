...
public class TestCase3 extends LaunchAndQuite {
	@Test
	public void scenario1() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[contains(@value,'UnifiedPaymentsInterface')]")).click();
//		Select s1 = new Select(driver.findElement(By.xpath("//span/select[@name='ppw-emiCreditCardSelection']")));
