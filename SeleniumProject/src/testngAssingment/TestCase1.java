...
public class TestCase1 extends LaunchAndQuite {
	@Test
	public void amazonPayLater() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[starts-with(@value,'instrumentId=AmazonCredit')]")).click();
		Thread.sleep(3000);
//		driver.findElement(By.cssSelector("#orderSummaryPrimaryActionBtn-announce")).click();

		// ==
//		driver.findElement(By.xpath("//*[.='Amazon Pay Later']")).click();
//		Thread.sleep(3000);
//		driver.findElement(By.xpath("//span[@class='a-button-inner']/span[.='Use this payment method']")).click();
